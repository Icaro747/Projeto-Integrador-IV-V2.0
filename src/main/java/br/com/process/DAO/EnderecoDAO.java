...
public class EnderecoDAO {
    ...
    public static boolean AdicionarFatura(Endereco endereco, Cliente cliente) {
        ...
        try {
            conexao = Conexao.abrirConexao();
            instrucaoSQL = conexao.prepareStatement("INSERT INTO EnderecoFatura (CEP, Endereco, Numero, Complemento, Bairro, Cidade, Estado, FK_Cliente) VALUES (?,?,?,?,?,?,?,?)");
    ...
    /**
     * 
     *Método para checar se o cliente já tem um endereço de fatura
     * @param cliente
     * @return se tiver retorna true, se não false
     */
    public static boolean CheckEnderecoFatura(Cliente cliente) {
        ...
        try {
            conexao = Conexao.abrirConexao();
            instrucaoSQL = conexao.prepareStatement("SELECT COUNT(*) AS QTD FROM EnderecoFatura WHERE FK_Cliente = ?");
    ...
    public static List<Endereco> ClienteEnderecoFatura(Cliente cliente) {
        ...
        try {
            conexao = Conexao.abrirConexao();
            instrucaoSQL = conexao.prepareStatement("SELECT * FROM EnderecoFatura WHERE FK_Cliente = ?");
